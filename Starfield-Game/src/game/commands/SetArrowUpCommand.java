...
/**
 * Der SetArrowUpCommand ist für das Setzen eines Pfeils nach oben verantwortlich.
 * 
 * @author Nikolaj
 */
public class SetArrowUpCommand extends AbstractCommand {
	...
	/**
	 * Initiiert das Setzen eines Pfeils nach oben durch die im Event übergebene Quelle Field.
	 */
	@Override
	public void execute() {
		if (this.getE().getSource() instanceof Field) {
			((Field) this.getE().getSource()).setUserContent(AllowedContent.CONTENT_ARROW_U);
		}
	}
